...
import it.buracchi.cifrari.gui.affine.AffineGUI;
import it.buracchi.cifrari.gui.enigma.EnigmaGUI;
import it.buracchi.cifrari.gui.hill.HillGUI;
import it.buracchi.cifrari.gui.oneTimePad.OneTimePadGUI;
import it.buracchi.cifrari.gui.permutation.PermutationGUI;
import it.buracchi.cifrari.gui.shift.ShiftGUI;
import it.buracchi.cifrari.gui.substitution.SubstitutionGUI;
import it.buracchi.cifrari.gui.vigenere.VigenereGUI;
...
public class Cifrari_GUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Cifrari_GUI window = new Cifrari_GUI();
