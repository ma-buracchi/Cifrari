...
public class PermutationGUIdecodificaRes extends JFrame {
	...
	public PermutationGUIdecodificaRes(int m, String p, String msg) {
		...
		textPane.setBounds(20, 36, 414, 214);
		textPane.setText(perm.decoding());
